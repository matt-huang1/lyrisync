...
- **Album colour** — an optional layer that tints the panel with the current cover's hue and cross-fades between tracks. It takes the cover's *hue* only and keeps its own brightness and saturation, so the colour is felt rather than noticed: a neon sleeve warms the glass, it does not stain it.
