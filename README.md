...
- **Global hotkey** — **⇧⌘L** shows and hides the lyrics from any app, full-screen ones included, without switching away from what you were doing. No Accessibility permission, no prompt.
...
- **The menu bar item** is the app's home: show lyrics, romanisation, spoken reference and speech rate, echo practice, show on all desktops, open at login, sync this song, quit. Entries appear only where they apply, so with every layer off the menu is just show/hide, Spaces and quit.
