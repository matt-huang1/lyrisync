...
from helpers import APP, PLAIN, SYNCED, click, item_for, land, load
...
#
# item_for and click moved into helpers.py when the sync-pass file needed
# them: a pass entered from the MENU and then tapped out on the WINDOW is
# one story, and it was two files that never met.
